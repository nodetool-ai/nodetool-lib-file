...
class ExtractMarkdown(GraphNode):
    ...
    pdf: types.DocumentRef | GraphNode | tuple[GraphNode, str] = Field(default=types.DocumentRef(type='document', uri='', asset_id=None, data=None), description='The PDF document to convert to markdown')
...
class ExtractTables(GraphNode):
    ...
    pdf: types.DocumentRef | GraphNode | tuple[GraphNode, str] = Field(default=types.DocumentRef(type='document', uri='', asset_id=None, data=None), description='The PDF document to extract tables from')
    start_page: int | GraphNode | tuple[GraphNode, str] = Field(default=0, description='First page to extract (0-based index)')
    end_page: int | GraphNode | tuple[GraphNode, str] = Field(default=-1, description='Last page to extract (-1 for last page)')
...
class ExtractText(GraphNode):
    ...
    pdf: types.DocumentRef | GraphNode | tuple[GraphNode, str] = Field(default=types.DocumentRef(type='document', uri='', asset_id=None, data=None), description='The PDF document to extract text from')
    start_page: int | GraphNode | tuple[GraphNode, str] = Field(default=0, description='First page to extract (0-based index)')
    end_page: int | GraphNode | tuple[GraphNode, str] = Field(default=-1, description='Last page to extract (-1 for last page)')
...
class ExtractTextBlocks(GraphNode):
    ...
    pdf: types.DocumentRef | GraphNode | tuple[GraphNode, str] = Field(default=types.DocumentRef(type='document', uri='', asset_id=None, data=None), description='The PDF document to extract text blocks from')
    start_page: int | GraphNode | tuple[GraphNode, str] = Field(default=0, description='First page to extract (0-based index)')
    end_page: int | GraphNode | tuple[GraphNode, str] = Field(default=-1, description='Last page to extract (-1 for last page)')
...
class ExtractTextWithStyle(GraphNode):
    ...
    pdf: types.DocumentRef | GraphNode | tuple[GraphNode, str] = Field(default=types.DocumentRef(type='document', uri='', asset_id=None, data=None), description='The PDF document to extract styled text from')
    start_page: int | GraphNode | tuple[GraphNode, str] = Field(default=0, description='First page to extract (0-based index)')
    end_page: int | GraphNode | tuple[GraphNode, str] = Field(default=-1, description='Last page to extract (-1 for last page)')
