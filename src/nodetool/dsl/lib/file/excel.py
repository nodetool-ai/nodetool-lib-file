...
class AutoFitColumns(GraphNode):
    ...
    workbook: types.ExcelRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ExcelRef(type='excel', uri='', asset_id=None, data=None), description='The Excel workbook to format')
...
class DataFrameToExcel(GraphNode):
    ...
    workbook: types.ExcelRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ExcelRef(type='excel', uri='', asset_id=None, data=None), description='The Excel workbook to write to')
    dataframe: types.DataframeRef | GraphNode | tuple[GraphNode, str] = Field(default=types.DataframeRef(type='dataframe', uri='', asset_id=None, data=None, columns=None), description='DataFrame to write')
    sheet_name: str | GraphNode | tuple[GraphNode, str] = Field(default='Sheet1', description='Target worksheet name')
...
class ExcelToDataFrame(GraphNode):
    ...
    workbook: types.ExcelRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ExcelRef(type='excel', uri='', asset_id=None, data=None), description='The Excel workbook to read from')
...
class FormatCells(GraphNode):
    ...
    background_color: str | GraphNode | tuple[GraphNode, str] = Field(default='FFFF00', description="Background color in hex format (e.g. 'FFFF00' for yellow)")
    text_color: str | GraphNode | tuple[GraphNode, str] = Field(default='000000', description='Text color in hex format')
...
class SaveWorkbook(GraphNode):
    ...
    workbook: types.ExcelRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ExcelRef(type='excel', uri='', asset_id=None, data=None), description='The Excel workbook to save')
    folder: types.FilePath | GraphNode | tuple[GraphNode, str] = Field(default=types.FilePath(type='file_path', path=''), description='The folder to save the file to.')
