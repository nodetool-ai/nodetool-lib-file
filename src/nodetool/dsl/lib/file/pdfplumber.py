...
class ExtractImages(GraphNode):
    ...
    pdf: types.DocumentRef | GraphNode | tuple[GraphNode, str] = Field(default=PydanticUndefined, description='The PDF file to extract images from')
...
class ExtractPageMetadata(GraphNode):
    ...
    pdf: types.DocumentRef | GraphNode | tuple[GraphNode, str] = Field(default=PydanticUndefined, description='The PDF file to analyze')
...
class ExtractTables(GraphNode):
    ...
    start_page: int | GraphNode | tuple[GraphNode, str] = Field(default=0, description='First page to extract tables from (0-based, None for first page)')
    end_page: int | GraphNode | tuple[GraphNode, str] = Field(default=4, description='Last page to extract tables from (0-based, None for last page)')
...
class ExtractText(GraphNode):
    ...
    pdf: types.DocumentRef | GraphNode | tuple[GraphNode, str] = Field(default=types.DocumentRef(type='document', uri='', asset_id=None, data=None), description='The PDF file to extract text from')
    start_page: int | GraphNode | tuple[GraphNode, str] = Field(default=0, description='The start page to extract. 0-based indexing')
    end_page: int | GraphNode | tuple[GraphNode, str] = Field(default=4, description='The end page to extract. -1 for all pages')
